...
save('output_langevin','output_langevin');
save('time_ltmcmc','time_ltmcmc');

fprintf('Running Langevin tlmalt...\n');
tic;
output_tmlmalt = tlmalt_par('nsamples', 500, ...
                                       'loglikelihood', loglikelihood, ...
                                       'priorpdf', priorpdf, ...
                                       'priorrnd', priorrnd, ...
                                       'burnin', 20, ...
                                       'epsilon',0.1);
time_tmlmalt = toc;
samples_tmalt = output_tmlmalt.samples;
save('output_tlmalt','output_tmlmalt');
save('time_tmlmalt','time_tmlmalt');